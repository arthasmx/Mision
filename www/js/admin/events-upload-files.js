...
// main picture
  ...
  var mp_uploader = new plupload.Uploader( get_shared_options( baseUrl + '/events-up/event-main-pix','uploader_f_main_pix','main-pix-pick','jpg') );
...
//gallery zip file
  ...
  var zip_uploader = new plupload.Uploader( get_shared_options( baseUrl + '/events-up/event-zip-gallery','uploader_f_zipped','zipped-file-pick','zip') );
...
// gallery
  jQuery('#uploader_f_gallery').pluploadQueue( get_shared_jqUIwidget_options('/events-up/event-gallery','jpg','5','100', 'gallery',false,true) );
