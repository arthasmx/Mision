<?php
class Module_User_Repository_Model_User_Forms_Areas_Admin_UserEdition extends Core_Model_Repository_Model {
	...
	if(!$post){
		...
		// Nombre
			$form->addElement('text', 'nombre', array(
					'description' => App::xlat('ADMIN_PANEL_FORM_name'),
					'required' => true,
					'validators' => array(
...
//			$form->getElement('nombre')->getDecorator('Element')->addClass('bg');
		...
		// Email
			$form->addElement('text', 'email', array(
					'description' => App::xlat("ADMIN_PANEL_FORM_email"),
					'required' => true,
		            'validators' => array(
		                	'EmailAddress',
...
//			$form->getElement('email')->getDecorator('Element')->addClass('bg');
		...
		// Telefono
			$form->addElement('text', 'telefono', array(
					'description' => App::xlat('ADMIN_PANEL_FORM_phone'),
					'validators' => array(
...
//			$form->getElement('telefono')->getDecorator('Element')->addClass('float-left');
		...
		// Extension
			$form->addElement(
				...
				'extension',
				array(
					'description' => App::xlat('ADMIN_PANEL_FORM_ext'),
					'validators' => array(
...
//			$form->getElement('extension')->getDecorator('Element')->addClass('width-30');
		...
		// Fax
			$form->addElement('text', 'fax', array(
					'description' => App::xlat('ADMIN_PANEL_FORM_fax'),
					'validators' => array(
			            	array('stringLength', true, array(7))
			        )
			));
		...
		// Web
			$form->addElement('text', 'web', array(
					'description' => App::xlat('ADMIN_PANEL_FORM_web'),
					'validators' => array(
...
$form->getDisplayGroup('contactinfo')->getDecorator('Group')->addClass('no-border float-left pad-10');
		...
		// direccion
			$form->addElement('text', 'direccion', array(
					'description' => App::xlat('ADMIN_PANEL_FORM_address'),
					'validators' => array(
			            	array('stringLength', true, array(9))
			        ),
			        'size'=>35,
		...
		// Colonia
			$form->addElement('text', 'colonia', array(
					'description' => App::xlat('ADMIN_PANEL_FORM_section'),
					'validators' => array(
		...
		// C. Postal
			$form->addElement('text', 'cp', array(
					'description' => App::xlat('ADMIN_PANEL_FORM_zip'),
					'validators' => array(
			            	array('stringLength', true, array(5))
			        ),
			        'size'=>10,
		...
		// Ciudad
			$form->addElement('text', 'ciudad', array(
					'description' => App::xlat('ADMIN_PANEL_FORM_city'),
					'validators' => array(
			            	array('stringLength', true, array(3))
			        ),
			        'size'=>35,
		...
		// Paises
			...
			$form->addElement('select', 'pais', array(
													'description' => App::xlat('ADMIN_PANEL_FORM_country'),
										            'multiOptions' => $paises,
													'onChange'=>'genericos.loadSelectList(this.value,"estado","'.App::xlat('ADMIN_PANEL_FORM_loading').'","'.App::xlat('ADMIN_PANEL_FORM_loading_error').'")',
										      )
			);
			if($cliente){
			...
			$form->addElement('select', 'estado', array(
													'description' => App::xlat('ADMIN_PANEL_FORM_state'),
